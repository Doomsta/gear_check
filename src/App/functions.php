...
class Functions
{
    public static function get_item_stats($id)
    {
        ...
        // armor value
        $data[StatInterface::ITEM_MOD_ARMOR] = $tmp['armor'];
    ...
    public static function add_item_gems($item)
    {
    ...
    public static function get_gems_stats($id)
    {
    ...
    public static function get_item_gems($id)
    {
        $query = 'SELECT `socketColor_1`, `socketColor_2`, `socketColor_3`, `socketBonus`
        FROM `' . MYSQL_DATABASE_TDB . '`.`item_template`
        WHERE `entry` = ' . $id . '';
